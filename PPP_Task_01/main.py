...
Original file is located at
    https://colab.research.google.com/drive/1sAstSutwXZB9Wo_Tm2wJRPJrL7YxgLXd
...
print('It is a pleasure to meet you,', name, surname, age, 'years old!')
...
if number1 % number2 == 0:
    result = "can be divided by the second one"
else:
    result = "can not be divided by the second one"
...
if operation == "+":
    ...
    if num2 != 0:
        ...
        print('You can not divide by zero, bro.')
        result = 'oh, no result bro('
else:
    result = "Invalid operation"
